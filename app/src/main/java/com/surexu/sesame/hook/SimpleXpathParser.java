...
public class SimpleXpathParser {
     ...
     * 解析并执行 XPath 查询
     */
    public static List<com.surexu.sesame.hook.SimpleViewImage> evaluate(com.surexu.sesame.hook.SimpleViewImage root, String xpath) {
        List<com.surexu.sesame.hook.SimpleViewImage> results = new ArrayList<>();
     ...
     * 查找匹配指定类名和属性的元素
     */
    private static List<com.surexu.sesame.hook.SimpleViewImage> findElements(
            com.surexu.sesame.hook.SimpleViewImage root,
            String className,
            String attrName,
            String attrValue,
            boolean contains
    ...
    private static void findElementsRecursive(
            com.surexu.sesame.hook.SimpleViewImage node,
            String className,
            String attrName,
            String attrValue,
            boolean contains,
            List<com.surexu.sesame.hook.SimpleViewImage> results
    ) {
        ...
        // 递归遍历子节点
        for (com.surexu.sesame.hook.SimpleViewImage child : node.getChildren()) {
     ...
     * 查找指定类名的元素
     */
    private static List<com.surexu.sesame.hook.SimpleViewImage> findElementsByTag(com.surexu.sesame.hook.SimpleViewImage root, String className) {
        List<com.surexu.sesame.hook.SimpleViewImage> results = new ArrayList<>();
