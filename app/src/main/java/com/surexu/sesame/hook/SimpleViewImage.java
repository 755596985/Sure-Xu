...
public class SimpleViewImage {
    ...
    public SimpleViewImage xpath2One(String xpath) {
        List<SimpleViewImage> results = com.surexu.sesame.hook.SimpleXpathParser.evaluate(this, xpath);
        if (!results.isEmpty()) {
            return results.get(0);
        }
        return com.surexu.sesame.hook.SimplePageManager.tryGetTopView(xpath);
    }
